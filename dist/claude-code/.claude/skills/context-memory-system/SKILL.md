...
**🔴 边界判断 (project.md vs request.md):**
- 问"这个信息下次任务还有用吗?" → 是 = `project.md`，否 = `request.md`
- 问"这是项目结构/API/架构知识吗?" → 是 = `project.md`，否 = `request.md`
- **API 对比、模块架构、技术方案** → 永远属于 `project.md`
- **本次需求的边界条件、用户确认细节** → 属于 `request.md`
...
### 最佳实践指南
遇到以下情况时阅读 `.flowmem/docs/best-practices.md`:冷启动新项目、不确定如何拆分文档、陷入循环/死胡同、需要高级技巧
