...
### 结构模板
- `.flowmem/templates/project-mature.md` - project.md 模板
- `.flowmem/templates/request.md` - 包含澄清对话和自检
- `.flowmem/templates/todolist.md` - 精简版,仅任务清单
- `.flowmem/templates/task_log.md` - 单个任务的详细日志模板

### Few-Shot 示例
- `.flowmem/examples/01-new-feature/` - 新功能开发
- `.flowmem/examples/02-refactor/` - 重构
- `.flowmem/examples/03-debug/` - 调试

### 辅助工具
- `.flowmem/scripts/refresh-context.sh` - 上下文刷新
- `.flowmem/scripts/archive-task.sh` - 任务归档

### 最佳实践指南
建议在以下情况阅读 `.flowmem/docs/best-practices.md`:
- 接手新项目(冷启动流程)
- 不确定如何拆分文档
- 陷入循环或死胡同
- 了解高级技巧(如错误恢复模式)
